...
router.post('/create', readCookie_1.cookieRead, controllerClients_1.createClient);
router.get('/allClients', readCookie_1.cookieRead, controllerClients_1.allClients);
