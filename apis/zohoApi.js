...
var ZohoApi = /** @class */ (function () {
    ...
    ZohoApi.prototype.createContact = function (endpoint, newContact) {
        return this._requestPost(axios_1["default"].post, process.env.BASE_URL + endpoint, newContact);
    };
    ZohoApi.prototype.getAllContacts = function (endpoint) {
        return this._requestGet(axios_1["default"].get, process.env.BASE_URL + endpoint);
    };
    //Invoices:
    ZohoApi.prototype.createInvoice = function (endpoint, newInvoice) {
        return this._requestPost(axios_1["default"].post, process.env.BASE_URL + endpoint, newInvoice);
    };
    ZohoApi.prototype.getAllInvoices = function (endpoint) {
        return this._requestGet(axios_1["default"].get, process.env.BASE_URL + endpoint);
    };
    ZohoApi.prototype._requestPost = function (method, url, body) {
    ...
    ZohoApi.prototype._requestGet = function (method, url) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
